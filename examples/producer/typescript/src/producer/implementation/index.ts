...
export class Producer {
	...
	public readonly events: {
		...
		serverEventsUserKickOff:
			new Subject<Protocol.ServerEvents.UserKickOff>(),
	...
	constructor(server: Server, context: Context, options?: Options) {
		...
		this._subscriptions.serverEventsUserKickOffHandlerSub =
			this.events.serverEventsUserKickOff.subscribe(
		...
		this._subscriptions.serverEventsUserAlertHandlerSub =
			this.events.serverEventsUserAlert.subscribe(
