...
export namespace Message {
    ...
    export class Request extends Protocol.Convertor implements IRequest, ISigned<Request> {
        ...
        public encode(): ArrayBufferLike {
            return this.collect([
                () => this.getBufferFromBuf<string>(26, Protocol.ESize.u64, Protocol.Primitives.StrUTF8.encode, this.user),
                () => this.getBufferFromBuf<string>(27, Protocol.ESize.u64, Protocol.Primitives.StrUTF8.encode, this.message),
            ]);
        }
        ...
        public decode(buffer: ArrayBufferLike): Error | undefined {
            ...
            const user: string | Error = this.getValue<string>(storage, 26, Protocol.Primitives.StrUTF8.decode);
            if (user instanceof Error) {
                return user;
            } else {
                this.user = user;
            }
            const message: string | Error = this.getValue<string>(storage, 27, Protocol.Primitives.StrUTF8.decode);
            if (message instanceof Error) {
                return message;
            } else {
                this.message = message;
    ...
    export class Accepted extends Protocol.Convertor implements IAccepted, ISigned<Accepted> {
        ...
        public encode(): ArrayBufferLike {
            return this.collect([
                () => this.getBufferFromBuf<string>(29, Protocol.ESize.u64, Protocol.Primitives.StrUTF8.encode, this.uuid),
            ]);
        }
        ...
        public decode(buffer: ArrayBufferLike): Error | undefined {
            ...
            const uuid: string | Error = this.getValue<string>(storage, 29, Protocol.Primitives.StrUTF8.decode);
            if (uuid instanceof Error) {
                return uuid;
            } else {
                this.uuid = uuid;
    ...
    export class Denied extends Protocol.Convertor implements IDenied, ISigned<Denied> {
        ...
        public encode(): ArrayBufferLike {
            return this.collect([
                () => this.getBufferFromBuf<string>(31, Protocol.ESize.u64, Protocol.Primitives.StrUTF8.encode, this.reason),
            ]);
        }
    ...
    export class Err extends Protocol.Convertor implements IErr, ISigned<Err> {
        ...
        public encode(): ArrayBufferLike {
            return this.collect([
                () => this.getBufferFromBuf<string>(33, Protocol.ESize.u64, Protocol.Primitives.StrUTF8.encode, this.error),
            ]);
        }
        ...
        public decode(buffer: ArrayBufferLike): Error | undefined {
            ...
            const error: string | Error = this.getValue<string>(storage, 33, Protocol.Primitives.StrUTF8.decode);
            if (error instanceof Error) {
                return error;
            } else {
                this.error = error;
...
export namespace Messages {
    ...
    export class Message extends Protocol.Convertor implements IMessage, ISigned<Message> {
        ...
        public encode(): ArrayBufferLike {
            return this.collect([
                () => this.getBuffer(36, Protocol.ESize.u8, Protocol.Primitives.u64.getSize(), Protocol.Primitives.u64.encode(this.timestamp)),
                () => this.getBufferFromBuf<string>(37, Protocol.ESize.u64, Protocol.Primitives.StrUTF8.encode, this.user),
        ...
        public decode(buffer: ArrayBufferLike): Error | undefined {
            ...
            const timestamp: bigint | Error = this.getValue<bigint>(storage, 36, Protocol.Primitives.u64.decode);
            if (timestamp instanceof Error) {
                return timestamp;
            } else {
                this.timestamp = timestamp;
            }
            const user: string | Error = this.getValue<string>(storage, 37, Protocol.Primitives.StrUTF8.decode);
            if (user instanceof Error) {
                return user;
            } else {
                this.user = user;
...
export namespace UserLogin {
    ...
    export class Request extends Protocol.Convertor implements IRequest, ISigned<Request> {
        ...
        public encode(): ArrayBufferLike {
            return this.collect([
                () => this.getBufferFromBuf<string>(47, Protocol.ESize.u64, Protocol.Primitives.StrUTF8.encode, this.username),
            ]);
        }
        ...
        public decode(buffer: ArrayBufferLike): Error | undefined {
            ...
            const username: string | Error = this.getValue<string>(storage, 47, Protocol.Primitives.StrUTF8.decode);
            if (username instanceof Error) {
                return username;
            } else {
                this.username = username;
    ...
    export class Accepted extends Protocol.Convertor implements IAccepted, ISigned<Accepted> {
        ...
        public encode(): ArrayBufferLike {
            return this.collect([
                () => this.getBufferFromBuf<string>(49, Protocol.ESize.u64, Protocol.Primitives.StrUTF8.encode, this.uuid),
            ]);
        }
        ...
        public decode(buffer: ArrayBufferLike): Error | undefined {
            ...
            const uuid: string | Error = this.getValue<string>(storage, 49, Protocol.Primitives.StrUTF8.decode);
            if (uuid instanceof Error) {
                return uuid;
            } else {
                this.uuid = uuid;
    ...
    export class Denied extends Protocol.Convertor implements IDenied, ISigned<Denied> {
        ...
        public encode(): ArrayBufferLike {
            return this.collect([
                () => this.getBufferFromBuf<string>(51, Protocol.ESize.u64, Protocol.Primitives.StrUTF8.encode, this.reason),
            ]);
        }
        ...
        public decode(buffer: ArrayBufferLike): Error | undefined {
            ...
            const reason: string | Error = this.getValue<string>(storage, 51, Protocol.Primitives.StrUTF8.decode);
            if (reason instanceof Error) {
                return reason;
            } else {
                this.reason = reason;
    ...
    export class Err extends Protocol.Convertor implements IErr, ISigned<Err> {
        ...
        public encode(): ArrayBufferLike {
            return this.collect([
                () => this.getBufferFromBuf<string>(53, Protocol.ESize.u64, Protocol.Primitives.StrUTF8.encode, this.error),
            ]);
        }
        ...
        public decode(buffer: ArrayBufferLike): Error | undefined {
            ...
            const error: string | Error = this.getValue<string>(storage, 53, Protocol.Primitives.StrUTF8.decode);
            if (error instanceof Error) {
                return error;
            } else {
                this.error = error;
...
export namespace UserInfo {
    ...
    export class Accepted extends Protocol.Convertor implements IAccepted, ISigned<Accepted> {
        ...
        public encode(): ArrayBufferLike {
            return this.collect([
                () => this.getBufferFromBuf<string>(57, Protocol.ESize.u64, Protocol.Primitives.StrUTF8.encode, this.browser),
            ]);
        }
        ...
        public decode(buffer: ArrayBufferLike): Error | undefined {
            ...
            const browser: string | Error = this.getValue<string>(storage, 57, Protocol.Primitives.StrUTF8.decode);
    ...
    export class Denied extends Protocol.Convertor implements IDenied, ISigned<Denied> {
        ...
        public encode(): ArrayBufferLike {
            return this.collect([
                () => this.getBufferFromBuf<string>(59, Protocol.ESize.u64, Protocol.Primitives.StrUTF8.encode, this.reason),
            ]);
        }
        ...
        public decode(buffer: ArrayBufferLike): Error | undefined {
            ...
            const reason: string | Error = this.getValue<string>(storage, 59, Protocol.Primitives.StrUTF8.decode);
            if (reason instanceof Error) {
                return reason;
            } else {
                this.reason = reason;
    ...
    export class Err extends Protocol.Convertor implements IErr, ISigned<Err> {
        ...
        public encode(): ArrayBufferLike {
            return this.collect([
                () => this.getBufferFromBuf<string>(61, Protocol.ESize.u64, Protocol.Primitives.StrUTF8.encode, this.error),
            ]);
        }
        ...
        public decode(buffer: ArrayBufferLike): Error | undefined {
            ...
            const error: string | Error = this.getValue<string>(storage, 61, Protocol.Primitives.StrUTF8.decode);
            if (error instanceof Error) {
                return error;
            } else {
                this.error = error;
...
export namespace Users {
    ...
    export class User extends Protocol.Convertor implements IUser, ISigned<User> {
        ...
        public encode(): ArrayBufferLike {
            return this.collect([
                () => this.getBufferFromBuf<string>(64, Protocol.ESize.u64, Protocol.Primitives.StrUTF8.encode, this.name),
                () => this.getBufferFromBuf<string>(65, Protocol.ESize.u64, Protocol.Primitives.StrUTF8.encode, this.uuid),
            ]);
        }
        ...
        public decode(buffer: ArrayBufferLike): Error | undefined {
            ...
            const name: string | Error = this.getValue<string>(storage, 64, Protocol.Primitives.StrUTF8.decode);
            if (name instanceof Error) {
                return name;
            } else {
                this.name = name;
            }
            const uuid: string | Error = this.getValue<string>(storage, 65, Protocol.Primitives.StrUTF8.decode);
            if (uuid instanceof Error) {
                return uuid;
            } else {
                this.uuid = uuid;
    ...
    export class Request extends Protocol.Convertor implements IRequest, ISigned<Request> {
        ...
        public static getSignature(): string { return 'Request'; }
        public static getId(): number { return 66; }
    ...
    export class Response extends Protocol.Convertor implements IResponse, ISigned<Response> {
        ...
        public encode(): ArrayBufferLike {
            return this.collect([
                () => { const self: User = User.defaults(); return this.getBufferFromBuf<User[]>(68, Protocol.ESize.u64, self.encodeSelfArray.bind(self), this.users); },
            ]);
        }
        ...
        public decode(buffer: ArrayBufferLike): Error | undefined {
            ...
            const arrusers: Array<any> | Error = this.getValue<User[]>(storage, 68, arrusersInst.decodeSelfArray.bind(arrusersInst));
    ...
    export class Err extends Protocol.Convertor implements IErr, ISigned<Err> {
        ...
        public encode(): ArrayBufferLike {
            return this.collect([
                () => this.getBufferFromBuf<string>(70, Protocol.ESize.u64, Protocol.Primitives.StrUTF8.encode, this.error),
            ]);
        }
        ...
        public decode(buffer: ArrayBufferLike): Error | undefined {
            ...
            const error: string | Error = this.getValue<string>(storage, 70, Protocol.Primitives.StrUTF8.decode);
            if (error instanceof Error) {
                return error;
            } else {
                this.error = error;
