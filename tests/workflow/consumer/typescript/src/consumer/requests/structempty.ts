...
export class StructEmpty extends Protocol.StructEmpty {
    ...
    constructor(request: Protocol.IStructEmpty, consumer?: Consumer) {
        super(request);
                ...
                switch (this._state) {
                    case ERequestState.Pending:
                        ...
                        if (message === undefined) {
                            return reject(new Error(`Expecting message for "StructEmpty".`));
                        } else if (message !== undefined && message.StructEmptyB !== undefined) {
