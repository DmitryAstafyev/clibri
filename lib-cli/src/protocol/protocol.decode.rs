...
pub trait Decode<T> {
    ...
    fn decode(storage: &mut Storage, name: String) -> Result<T, String>;

}

impl Decode<u8> for u8 {
    fn decode(storage: &mut Storage, name: String) -> Result<u8, String> {
...
impl Decode<u16> for u16 {
    fn decode(storage: &mut Storage, name: String) -> Result<u16, String> {
        if let Some(buf) = storage.get(name.clone()) {
...
impl Decode<u32> for u32 {
    fn decode(storage: &mut Storage, name: String) -> Result<u32, String> {
        if let Some(buf) = storage.get(name.clone()) {
...
impl Decode<u64> for u64 {
    fn decode(storage: &mut Storage, name: String) -> Result<u64, String> {
        if let Some(buf) = storage.get(name.clone()) {
...
impl Decode<i8> for i8 {
    fn decode(storage: &mut Storage, name: String) -> Result<i8, String> {
        if let Some(buf) = storage.get(name.clone()) {
...
impl Decode<i16> for i16 {
    fn decode(storage: &mut Storage, name: String) -> Result<i16, String> {
        if let Some(buf) = storage.get(name.clone()) {
...
impl Decode<i32> for i32 {
    fn decode(storage: &mut Storage, name: String) -> Result<i32, String> {
        if let Some(buf) = storage.get(name.clone()) {
...
impl Decode<i64> for i64 {
    fn decode(storage: &mut Storage, name: String) -> Result<i64, String> {
        if let Some(buf) = storage.get(name.clone()) {
...
impl Decode<f32> for f32 {
    fn decode(storage: &mut Storage, name: String) -> Result<f32, String> {
        if let Some(buf) = storage.get(name.clone()) {
...
impl Decode<f64> for f64 {
    fn decode(storage: &mut Storage, name: String) -> Result<f64, String> {
        if let Some(buf) = storage.get(name.clone()) {
...
impl Decode<bool> for bool {
    fn decode(storage: &mut Storage, name: String) -> Result<bool, String> {
        if let Some(buf) = storage.get(name.clone()) {
            if buf.len() < sizes::U8_LEN {
                return Err(format!("To extract u8 value buffer should have length at least {} bytes, but length is {}", sizes::U8_LEN, buf.len()));
            }
...
impl Decode<String> for String {
    fn decode(storage: &mut Storage, name: String) -> Result<String, String> {
        if let Some(buf) = storage.get(name.clone()) {
...
impl Decode<Vec<u8>> for Vec<u8> {
    fn decode(storage: &mut Storage, name: String) -> Result<Vec<u8>, String> {
        if let Some(buf) = storage.get(name.clone()) {
...
impl Decode<Vec<u16>> for Vec<u16> {
    fn decode(storage: &mut Storage, name: String) -> Result<Vec<u16>, String> {
        if let Some(buf) = storage.get(name.clone()) {
...
impl Decode<Vec<u32>> for Vec<u32> {
    fn decode(storage: &mut Storage, name: String) -> Result<Vec<u32>, String> {
        if let Some(buf) = storage.get(name.clone()) {
...
impl Decode<Vec<u64>> for Vec<u64> {
    fn decode(storage: &mut Storage, name: String) -> Result<Vec<u64>, String> {
        if let Some(buf) = storage.get(name.clone()) {
...
impl Decode<Vec<i8>> for Vec<i8> {
    fn decode(storage: &mut Storage, name: String) -> Result<Vec<i8>, String> {
        if let Some(buf) = storage.get(name.clone()) {
...
impl Decode<Vec<i16>> for Vec<i16> {
    fn decode(storage: &mut Storage, name: String) -> Result<Vec<i16>, String> {
        if let Some(buf) = storage.get(name.clone()) {
...
impl Decode<Vec<i32>> for Vec<i32> {
    fn decode(storage: &mut Storage, name: String) -> Result<Vec<i32>, String> {
        if let Some(buf) = storage.get(name.clone()) {
...
impl Decode<Vec<i64>> for Vec<i64> {
    fn decode(storage: &mut Storage, name: String) -> Result<Vec<i64>, String> {
        if let Some(buf) = storage.get(name.clone()) {
...
impl Decode<Vec<f32>> for Vec<f32> {
    fn decode(storage: &mut Storage, name: String) -> Result<Vec<f32>, String> {
        if let Some(buf) = storage.get(name.clone()) {
...
impl Decode<Vec<f64>> for Vec<f64> {
    fn decode(storage: &mut Storage, name: String) -> Result<Vec<f64>, String> {
        if let Some(buf) = storage.get(name.clone()) {
...
impl Decode<Vec<String>> for Vec<String> {
    fn decode(storage: &mut Storage, name: String) -> Result<Vec<String>, String> {
        if let Some(buf) = storage.get(name.clone()) {
...
impl<T> Decode<Vec<T>> for Vec<T> where T: StructDecode {
    fn decode(storage: &mut Storage, name: String) -> Result<Vec<T>, String> {
        if let Some(buf) = storage.get(name.clone()) {
