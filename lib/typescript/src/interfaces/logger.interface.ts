...
export abstract class Logger {
    ...
    public static readonly GLOBAL_ALIAS: string = '___FIBER_GLOBAL_LOGS_ALIAS___';
    ...
    public getSignature(level: number): string {
        return`[${this._setLastTimeStamp()}ms\t][${LogLevelLabels[level]}]${this._alias === undefined ? '' : `[${this._alias}]`}`;
    }
