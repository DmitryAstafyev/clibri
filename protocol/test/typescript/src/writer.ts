...
export const usecases: Array<{
	name: string;
	entity: Protocol.Convertor<any> | Protocol.Enum<any>;
}> = [];
...
usecases.push({
	...
	entity: (() => {
		...
		EnumInts.set({
			Option_a: new Protocol.StructExampleA({
				field_str: "test",
				field_str_empty: "",
				field_u8: 1,
				field_u16: 2,
...
usecases.push({
	...
	entity: (() => {
		const EnumInts = new Protocol.GroupD.EnumExampleP();
		EnumInts.set({
			Option_b: new Protocol.GroupD.StructExampleP({
...
usecases.push({
	...
	entity: (() => {
		const EnumInts = new Protocol.GroupD.EnumExampleP();
		EnumInts.set({
			Option_c: new Protocol.GroupB.StructExampleA({
				field_u8: 1,
				field_u16: 2,
			}),
		});
...
usecases.push({
	...
	entity: (() => {
		const EnumInts = new Protocol.GroupD.EnumExampleP();
		EnumInts.set({
			Option_d: new Protocol.GroupB.GroupC.StructExampleA({
				field_u8: 1,
				field_u16: 2,
			}),
		});
...
usecases.push(
	...[
		{
			name: "StructExampleA",
			entity: new Protocol.StructExampleA({
				field_str: "test",
				field_str_empty: "",
				field_u8: 1,
				field_u16: 2,
		...
		{
			name: "StructExampleB",
			entity: new Protocol.StructExampleB({
		...
		{
			name: "StructExampleC",
			entity: new Protocol.StructExampleC({
				field_str: "test",
				field_u8: 1,
				field_u16: 2,
				field_u32: 3,
		...
		{
			name: "StructExampleD",
			entity: new Protocol.StructExampleD({
				field_str: ["test_a", "test_b"],
				field_u8: [1, 2, 3, 4],
				field_u16: [1, 2, 3, 4],
				field_u32: [1, 2, 3, 4],
		...
		{
			name: "StructExampleE",
			entity: new Protocol.StructExampleE({
				field_a: {
					Option_a: "Option_a",
				},
				field_b: {
		...
		{
			name: "StructExampleF",
			entity: new Protocol.StructExampleF({
				field_a: undefined,
				field_b: undefined,
				field_c: {
					Option_u8: [1],
		...
		{
			name: "StructExampleG",
			entity: new Protocol.StructExampleG({
				field_a: new Protocol.StructExampleA({
					field_str: "test",
					field_str_empty: "",
					field_u8: 1,
		...
		{
			name: "StructExampleJ",
			entity: new Protocol.StructExampleJ({
				field_a: new Protocol.StructExampleA({
					field_str: "test",
					field_str_empty: "",
					field_u8: 1,
		...
		{
			name: "StructExampleEmpty",
			entity: new Protocol.StructExampleEmpty({}),
		},
		{
			name: "GroupAStructExampleA",
			entity: new Protocol.GroupA.StructExampleA({
				field_u8: 1,
				field_u16: 2,
				opt: {
					Option_a: "Option_a",
		...
		{
			name: "GroupAStructExampleB",
			entity: new Protocol.GroupA.StructExampleB({
				field_u8: 1,
				field_u16: 2,
		...
		{
			name: "GroupBStructExampleA",
			entity: new Protocol.GroupB.StructExampleA({
				field_u8: 1,
				field_u16: 2,
			}),
		},
		{
			...
			entity: new Protocol.GroupB.GroupC.StructExampleA({
				field_u8: 1,
				field_u16: 2,
			}),
		},
		{
			...
			entity: new Protocol.GroupB.GroupC.StructExampleB({
				field_u8: 1,
				field_u16: 2,
		...
		{
			name: "GroupDStructExampleP",
			entity: new Protocol.GroupD.StructExampleP({
				field_a: new Protocol.StructExampleA({
					field_str: "test",
					field_str_empty: "",
					field_u8: 1,
...
export function write(): Promise<void> {
	function wr(
		name: string,
		entity: Protocol.Convertor<any> | Protocol.Enum<any> | Buffer
	): Promise<void> {
		return new Promise((resolve, reject) => {
			if (
				(entity instanceof Protocol.Convertor ||
					entity instanceof Protocol.Enum) &&
				state.getMiddleware()
			) {
			...
			const target = path.resolve(
				dest,
				`${name}.prot.${state.getMiddleware() ? "middleware" : "bin"}`
			);
			...
			fs.open(target, "w", (errOpen, file) => {
				...
				fs.writeFile(
					...
					(errWrite: Error | undefined | null) => {
						...
						console.log(
							`[OK]\t[TS] File: ${target} has beed written: ${buf.byteLength} bytes.`
						);
						resolve(undefined);
					}
				);
