...
import { ISigned } from '../src/protocol.primitives.interface';
...
class Message extends Protocol.Convertor implements IMessage {
    ...
    public encode(): ArrayBufferLike {
        return this.collect([
            ...
            () => { const self: Nested = Nested.defaults(); return this.getBufferFromBuf<Nested[]>(26, Protocol.ESize.u64, self.encodeSelfArray.bind(self), this.arrNested); },
        ]);
    }
